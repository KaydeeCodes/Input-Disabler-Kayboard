...
This is an application created in C# in Jetbrains Rider, to work on Linux Mint 21.2. This will block the keyboard input for 30seconds. while creating a log file for each execution and a timer files to link to OBS or xSplit Broadcaster for countdowns during streaming sessions. 
